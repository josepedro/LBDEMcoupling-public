...
int main(int argc, char* argv[]) {
    ...
    // allOmega[4] = parameters.getOmega(); // without bulk viscosity modification
    */
    // Q27
    allOmega[0] = parameters.getOmega();     // relaxation of M200 and cyclic permutations
    allOmega[1] = parameters.getOmega();     // relaxation of M110 and cyclic permutations
    allOmega[2] = parameters.getOmega();    // relaxation of M210 and cyclic permutations
    allOmega[3] = parameters.getOmega();    // relaxation of M111 and cyclic permutations
    allOmega[4] = parameters.getOmega();    // relaxation of M220 and cyclic permutations
    allOmega[5] = parameters.getOmega();    // relaxation of M211 and cyclic permutations
    allOmega[6] = parameters.getOmega();    // relaxation of M221 and cyclic permutations
    allOmega[7] = parameters.getOmega();    // relaxation of M222 and cyclic permutations
    // allOmega[8] = 1.0; // relaxation of bulk moment (M200 + M020 + M002)
    allOmega[8] = parameters.getOmega(); // without bulk viscosity modification
